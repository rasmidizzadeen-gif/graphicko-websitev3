...
const PROJECTS = [
  { id: 1, title: 'Vortex FinTech', category: 'Branding', tag: 'Brand Identity', desc: 'Complete brand identity overhaul for a fintech startup.', color: '#0052ff', pattern: 'dots' },
  { id: 2, title: 'Lumina Health App', category: 'UI/UX', tag: 'UI/UX Design', desc: 'Mobile app design and comprehensive design system.', color: '#7c3aed', pattern: 'grid' },
  { id: 3, title: 'Stratos E-Commerce', category: 'Web', tag: 'Web Design', desc: 'Luxury e-commerce experience with 3x conversion lift.', color: '#059669', pattern: 'lines' },
  { id: 4, title: 'NovaBrew Campaign', category: 'Marketing', tag: 'Performance Ads', desc: 'Social media campaign achieving 4.8x ROAS.', color: '#d97706', pattern: 'circles' },
  { id: 5, title: 'Nexus SaaS Platform', category: 'UI/UX', tag: 'Product Design', desc: 'B2B SaaS dashboard redesign reducing churn by 30%.', color: '#e11d48', pattern: 'dots' },
  { id: 6, title: 'Echo Music Brand', category: 'Branding', tag: 'Brand Identity', desc: 'Gen-Z music streaming platform brand and identity.', color: '#0891b2', pattern: 'grid' },
  { id: 7, title: 'TechVault SEO', category: 'Marketing', tag: 'SEO Strategy', desc: 'Organic traffic grew 280% in 6 months.', color: '#9333ea', pattern: 'lines' },
  { id: 8, title: 'PureGlow Beauty', category: 'Branding', tag: 'Brand Identity', desc: 'Premium beauty brand entering the luxury market.', color: '#c2410c', pattern: 'circles' },
]
      ...
      <div className={styles.projectCard}>
        ...
        >
          ...
          <div className={styles.projectHover}>
            <Link to="/contact">
              <button className="btn btn-primary" style={{ fontSize: 13 }}>View Project</button>
            </Link>
          </div>
        </div>
      </div>
